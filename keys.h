  ...
  { MODKEY,               XK_r,                       spawn,          SHCMD("eww open dashboard --toggle") },
  { MODKEY,               XK_c,                       spawn,          SHCMD("eww open calendar --toggle") },
	...
	{ ShiftMask,            XF86XK_AudioMute,           spawn,          SHCMD("volume mic mute") },
	{ ShiftMask,            XF86XK_AudioLowerVolume,    spawn,          SHCMD("volume mic down") },
	{ ShiftMask,            XF86XK_AudioRaiseVolume,    spawn,          SHCMD("volume mic up") },
	{ MODKEY|ShiftMask,     XK_F1,                      spawn,          SHCMD("volume mic mute") },
	{ MODKEY|ShiftMask,     XK_F2,                      spawn,          SHCMD("volume mic down") },
	{ MODKEY|ShiftMask,     XK_F3,                      spawn,          SHCMD("volume mic up") },	
	...
	{ 0,                    XF86XK_TouchpadToggle,      spawn,          SHCMD("mouse touchpad") },
	{ MODKEY,               XK_F6,                      spawn,          SHCMD("mouse touchpad") },
